<template>
  <div class="videos-add app-container">
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" v-loading="tableLoading">
      ...
      <el-form-item label="是否需要密码" prop="type">
        <el-switch v-model="ruleForm.type" :active-value="2" :inactive-value="1"></el-switch>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" style="width: 150px" @click="submitForm"> 新增 </el-button>
      </el-form-item>
    </el-form>
...
export default class extends Vue {
  ...
  async addVideo() {
    const res = await this.executeApi(addVideo, this.ruleForm)
    if (res.code === 20000) {
      this.$message({
        type: 'success',
        message: '新增成功'
