<template>
  <div class="user-activity">
    <div class="post">
      ...
      <p>
        Lorem ipsum represents a long-held tradition for designers, typographers and the like. Some people hate it and argue for its demise, but others ignore the hate as they
        create awesome tools to help create filler text for everyone from bacon lovers to Charlie Sheen fans.
      </p>
    ...
    <div class="post">
      ...
      <ul class="list-inline">
        ...
        <li>
          <span class="link-black text-sm"> <svg-icon name="like" /> Like</span>
        </li>
      </ul>
    </div>
  </div>
