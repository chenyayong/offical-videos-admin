export default {
  route: {
    dashboard: 'Dashboard',
    videosList: 'Gestione Video',
    videosAdd: 'Aggiungi video',
    videosDetail: '视频详情',
    videosEdit: '视频编辑',
  ...
  guide: {
    description:
      'La pagina Guida è utile per alcune persone che entrano nel progetto per la prima volta. Puoi introdurre brevemente le funzionalità del progetto. Il demo è basato su ',
    button: 'Mostra guida'
  },
  components: {
    documentation: 'Documentazione',
